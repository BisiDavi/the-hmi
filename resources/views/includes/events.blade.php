<section class="container-fluid events">
  ...
  <div class="row">
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 flip-card">
      <div class="flip-card-inner event-1">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 flip-card">
      <div class="flip-card-inner event-2">
        <div class="flip-card-front-overlay">
          <div class="flip-card-front">
            <div class="flip-card-text">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 flip-card">
      <div class="flip-card-inner event-3">
        <div class="flip-card-front-overlay">
          <div class="flip-card-front">
            <div class="flip-card-text">
